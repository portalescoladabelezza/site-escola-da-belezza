...
import { Sparkles, MessageSquare, Mail, Layers, PhoneCall, TrendingUp, CheckCircle, BarChart3 } from 'lucide-react';
...
export const Advertise: React.FC = () => {
  ...
  const adOptions = [
    ...
    },
    {
      ...
      desc: 'Inclusão de chamada direcionada patrocinada em nossa newsletter semanal que dispara relatórios para mais de 14.800 iniciantes e profissionais de estética.',
  ...
  return (
    <main className="bg-[#FEFCFB] py-10 sm:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 text-left">
        ...
        {/* Portal statistics quick cards */}
        <section className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-2">
          <div className="bg-stone-50 border border-stone-200/80 p-6 rounded-2xl">
            <span className="text-3xl block">👥</span>
            <span className="block text-2xl sm:text-3xl font-serif font-bold text-stone-900 mt-2">14.800+</span>
            <span className="text-xs text-stone-500 block font-sans uppercase tracking-wider mt-1">Leitoras Cadastradas</span>
          </div>
          <div className="bg-stone-55 border border-stone-200/80 p-6 rounded-2xl">
            <span className="text-3xl block">🎯</span>
            <span className="block text-2xl sm:text-3xl font-serif font-bold text-stone-900 mt-2">78%</span>
            <span className="text-xs text-stone-500 block font-sans uppercase tracking-wider mt-1">Mulheres e Empreendedoras</span>
          </div>
          <div className="bg-[#FFF9F6] border border-[#F3E5DE] p-6 rounded-2xl">
            <span className="text-3xl block">📈</span>
            <span className="block text-2xl sm:text-3xl font-serif font-bold text-stone-900 mt-2">30.000+</span>
            <span className="text-xs text-stone-500 block font-sans uppercase tracking-wider mt-1">Visualizações Mensais</span>
          </div>
        </section>
            ...
            {adOptions.map((opt, index) => (
              ...
              >
                <div className="space-y-2.5">
                  <span className="text-3xl block" role="img" aria-label={opt.title}>
                    {opt.icon}
                  </span>

      ...
      <div className="border-b border-stone-800 bg-stone-950/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex items-center space-x-2 text-stone-400 text-xs font-sans">
            ...
            <span>Aprovado de acordo com diretrizes de Conteúdo Útil e Qualidade do Google</span>
          </div>
          <button
            onClick={scrollToTop}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8sm:gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs text-stone-400">
              ...
              <li className="pt-3">
                <p className="text-[10px] font-mono text-stone-500 uppercase">Privacidade & Uso</p>
                <div className="flex flex-wrap gap-x-2 gap-y-1.5 mt-2 text-[11px]">
                  <button onClick={() => onNavigate({ type: 'privacy' })} className="text-[#C5A880] hover:underline">
                    Privacidade
                  </button>
                  <span className="text-stone-700">|</span>
                  <button onClick={() => onNavigate({ type: 'terms' })} className="text-[#C5A880] hover:underline">
                    Termos
                  </button>
                  <span className="text-stone-700">|</span>
                  <button onClick={() => onNavigate({ type: 'cookies' })} className="text-[#C5A880] hover:underline">
                    Cookies
                  </button>
                </div>
              </li>
        ...
        <div className="mt-8 text-center text-xs text-stone-500 font-sans flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-[10px] uppercase tracking-widest font-mono">
            Feito para quem ama Beleza • CNPJ 45.326.161/0001-98
          </p>
        </div>
      </div>
    </footer>
